...
- [[file:construct_critique_improve_models.org][Construct, critique, improve models]]
- [[file:underlying_foundation.org][Underlying foundation]]
- [[file:why_not_what.org][Why not what]]
- [[file:for_the_sake_of_advancing_ai.org][For the sake of advancing AI]]
- [[file:technical_experiments_become_easier.org][Technical experiments become easier]]
- [[file:which_model_construction_process_works_as_a_whole.org][Which model construction process works as a whole?]]
